    ...
    <Container>
      ...
      <ul class=" grid gap-11 overflow-y-scroll snap-y scroll-pt-2 calc-max-h no-scroll">
        <li v-for="(observation,index) in observations.data.Observation" :key="index"
          ...
          <!-- delete btn -->
          <span
            class="absolute -top-2 -left-2 bg-gradient-to-b from-red-400 to-red-600 rounded-full w-6 h-6 px-1 text-4xl flex items-center justify-center button-shadow"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"></path>
            </svg></span>
          <!-- update btn -->
          <span
            class="absolute -top-2 -right-2 bg-gradient-to-b from-tan-hide-500 to-ecstasy-500 rounded-full w-6 h-6 px-1 text-4xl flex items-center justify-center button-shadow"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></span>
          <!-- comment btn -->
          <span
            class="absolute -bottom-2 -right-2 bg-gradient-to-b from-tan-hide-500 to-ecstasy-500 rounded-full w-6 h-6 px-1 text-4xl flex items-center justify-center button-shadow"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg></span>
